    ...
    <VStack w={'full'}   >
       ...
       <VStack w={'full'} alignItems={'flex-start'} p={'8'}  overflowY={'auto'} >
         <Heading>Sample Video 1</Heading>
          <Text>This is a Simple Vdio For Testing and Demo. This is Called  descripation </Text>
         </VStack>
    </VStack>
    <VStack  
        w={['full', 'xl']}
    ...
    >
       {videosArr.map((item, index) => (
         ...
         <Button
            variant={'ghost'}
            colorScheme={'purple'}
            onClick={() => setVideoSrc(item)}//So, in summary, this code generates a list of buttons, each representing a video lecture. When you click on a button, it updates the videoSrc state with the URL of the corresponding video, allowing you to display that video or perform any other action that involves the selected video.
          >
            Lecture {index+1}
          </Button>
        ))}
